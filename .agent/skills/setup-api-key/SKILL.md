---
name: setup-api-key
description: Guides users through the process of setting up an ElevenLabs API key for use with ElevenLabs skills and tools. Use when the user needs to configure an ElevenLabs API key, when ElevenLabs tools fail due to missing API key, or when the user mentions needing access to ElevenLabs.
license: MIT
